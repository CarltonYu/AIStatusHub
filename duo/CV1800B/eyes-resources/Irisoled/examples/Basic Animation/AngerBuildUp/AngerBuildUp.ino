/**********
  ...
  -------------------
  Purpose:
    Escalating emotion animation: normal -> angry -> furious -> angry -> normal.
  ...
  Usage:
    - Adjust speeds to control how quickly the anger builds and subsides.
...
const unsigned char* frames[] = {
  Irisoled::normal, Irisoled::angry, Irisoled::furious, Irisoled::angry, Irisoled::normal
};
const uint16_t delays[] = { 500, 500, 2000, 500, 2000 };
